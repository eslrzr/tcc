<div class="row">
    <div class="col-6">
        <div class="form-group">
            ...
            <input id="document-title" type="text" name="name" class="form-control" placeholder="{{ __('form.document_title') }}" required>
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            <label for="document-type"><i class="fas fa-file"></i> {{ __('form.document_type') }}</label>
            <select id="document-type" class="form-control" name="document_type_id" required>
...
<div class="row">
    <div class="col-6">
        <div class="form-group">
            ...
            <select id="link" class="form-control" name="linked_to">
