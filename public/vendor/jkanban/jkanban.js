    ...
    function __buildItemCard(item) {
      ...
      if (self.options.itemHandleOptions.enabled) {
          if ((self.options.itemHandleOptions.customHandler || undefined) === undefined) {
              ...
              result = '<div class="row"><div class=\'item_handle ' + customCssHandler + '\'><i class="item_handle fa fa-bars"></i></div><div>' + result + '</div><div id="project-actions' + item.id + '"></div></div>'
          } else {
